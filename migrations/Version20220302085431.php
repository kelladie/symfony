 ...
 */
final class Version20220302085431 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE hobby CHANGE desigantion designation VARCHAR(255) NOT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE hobby ADD desigantion VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, DROP designation');
